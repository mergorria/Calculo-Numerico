function [a, b, c, d] = cubic_spline_natural(x,y)
    ...
    # Es una funci¢¥on para el calculo de una Spline C¢¥ubica Natural, es decir con
    # derivadas segundas nulas en el contorno del dominio.
    # Programado en base a Burden Edici¢¥on 10 pag 110.
    # Ojo tener cuidado el contador i est¢¥a inicializado en 1.
    ...
    # Resolvemos el sistema lineal tridiagonal (Factorizaci¢¥on de Crout)
    % Paso 3:
    l = ones(n,1);
    u = zeros(n,1);
    z = zeros(n,1);
